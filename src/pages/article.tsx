...
const ArticlePage = ({ article }: React.PropsWithoutRef<Props>) => {
  ...
  return (
    <div className='max-w-5xl mx-auto space-y-2'>
      ...
      <div className='flex flex-nowrap space-x-10 relative min-h-screen'>
        <div className='text-xl tracking-wider leading-normal'>
          <p>{post}</p>
        </div>
        <div className='sticky top-10 h-56 border-l-2 border-r-2 border-opacity-5 border-white p-5 flex flex-col justify-between'>
